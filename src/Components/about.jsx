            ...
            <div className="bg-slate-900/50 backdrop-blur-md rounded-2xl p-8 shadow-xl border border-slate-700">
              ...
              <div className="flex flex-col sm:flex-row gap-4 mt-8">
                <a
                  ...
                  className="bg-amber-400 text-white px-6 py-3 rounded-full hover:shadow-lg hover:scale-105 transition-all duration-300 flex items-center justify-center gap-2"
                >
                  <Download size={20} />
                  Download CV
                </a>
